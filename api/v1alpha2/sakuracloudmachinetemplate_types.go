...
// +kubebuilder:resource:path=sakuracloudmachinetemplates,scope=Namespaced,categories=cluster-api
...
func init() {
	SchemeBuilder.Register(&SakuraCloudMachineTemplate{}, &SakuraCloudMachineTemplateList{})
}
